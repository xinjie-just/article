						...
						<div class="form-group">
	    					...
	    					<div class="col-sm-10">
	    						<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox1" name="modifyArticleTag" value="option1"> 高血压
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox2" name="modifyArticleTag" value="option2"> 糖尿病
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox3" name="modifyArticleTag" value="option3"> 肥胖
								</label>    						
	    						<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox1" name="modifyArticleTag" value="option4"> 老年病
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox2" name="modifyArticleTag" value="option5"> 心脏病
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox3" name="modifyArticleTag" value="option6"> 低血压
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox3" name="modifyArticleTag" value="option7"> 冠心病
								</label>
							</div>
						</div>
						<div class="form-group">
