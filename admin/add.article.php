	...
	<body>
		...
		<main id="main">
			...
			<div class="side-right">
				<div class="function">
					<a href="javascript:window.history.go(-1)" title="取消返回">
				...
				<form action="add.article.handle.php" enctype="multipart/form-data" method="post" id="addArticleForm" name="addArticleForm" class="form-horizontal add-article-form">
					<div class="form-group">
    					...
    					<div class="col-sm-10">
							<input type="text" id="title" name="title" class="form-control" placeholder="请输入文章标题" required autofocus>
						</div>
					</div>
					<div class="form-group">
    					...
    					<div class="col-sm-10">    						
    						...
    						<label class="checkbox-inline">
								<input type="checkbox" id="inlineCheckbox1" name="addArticleTag" value="option1"> 老年病
							</label>
							<label class="checkbox-inline">
								<input type="checkbox" id="inlineCheckbox2" name="addArticleTag" value="option2"> 心脏病
							</label>
							<label class="checkbox-inline">
								<input type="checkbox" id="inlineCheckbox3" name="addArticleTag" value="option3"> 低血压
							</label>
							<label class="checkbox-inline">
								<input type="checkbox" id="inlineCheckbox3" name="addArticleTag" value="option3"> 冠心病
							</label>
						</div>
					</div>
					<div class="form-group">
						<label for="link" class="col-sm-2 control-label">资讯地址</label>
    					<div class="col-sm-10">
							<input type="text" id="link" name="link" class="form-control" placeholder="请输入资讯地址" required>
						</div>
					</div>
					<div class="form-group">
						<label for="description" class="col-sm-2 control-label">内容导读</label>
    					<div class="col-sm-10">
							<textarea id="description" name="description" class="form-control" placeholder="请输入内容导读" required>
							</textarea>
						</div>
					</div>
					<div class="form-group">
						<label for="img" class="col-sm-2 control-label">缩率图</label>
    					<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="body" class="col-sm-2 control-label">主要内容</label>
    					<div class="col-sm-10">
